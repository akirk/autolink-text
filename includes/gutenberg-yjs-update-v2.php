...
/**
 * Encodes a Yjs updateV2 that wraps existing text in an existing Y.Text.
 *
 * @param array{client:int,clock:int}|null $open_origin       Character before the opening text.
 * @param array{client:int,clock:int}|null $open_right_origin First character after the opening text.
 * @param array{client:int,clock:int}|null $open_parent       Y.Text item ID, used only when there is no origin or right origin.
 * @param array{client:int,clock:int}|null $close_origin      Character before the closing text.
 * @param array{client:int,clock:int}|null $close_right_origin First character after the closing text.
